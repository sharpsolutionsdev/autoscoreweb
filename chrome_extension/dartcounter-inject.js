// Extension copy of scripts/injectors/dartcounter-inject.js
// This file is injected into app.dartcounter.net frames (manifest.json all_frames:true)
(function(){
  ...
  let ro = null, mo = null;
  let cricketGrid = null; // optional cricket grid JSON
  ...
  async function simulateInput(values){
    ...
    // cricket helpers (approximate mapping using provided grid)
